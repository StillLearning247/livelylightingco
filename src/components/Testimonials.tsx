  ...
  const testimonials = [
    {
      ...
      rating: 5,
      image: "/images/testimonials/jennifer_s.jpg"
    },
    {
      name: "Michael T.",
      ...
      rating: 5,
      image: "/images/testimonials/michael_t.jpg"
    },
    {
      name: "Sarah & David",
      ...
      rating: 5,
      image: "/images/testimonials/sara_david.jpg"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-indigo-200 max-w-3xl mx-auto">
            Don't just take our word for it. Here's what homeowners think about our service.
          </p>
        </div>
              ...
              <div className="grid grid-cols-2">
                <div className="p-10">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-300">{testimonials[currentIndex].location}</p>
                  </div>
                </div>
